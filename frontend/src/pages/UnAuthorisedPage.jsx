          ...
          <div className="p-8 md:p-12 flex flex-col items-center">
            ...
            <div className="relative mb-8 flex justify-center items-center">
              ...
              <div className="relative bg-transparent  size-48 flex items-center justify-center">
                <GiSecurityGate className="h-full w-full object-cover text-[#3191A6]" />
              </div>
            </div>

            {/* Headline */}
            <h1 className="text-[#b44559] animate-pulse dark:text-slate-50 text-[32px] font-bold text-center pb-3">
              403 - Access Denied
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mt-3 w-full max-w-[400px] justify-center">
              ...
              <button
                ...
                className="flex min-w-[140px] items-center justify-center rounded-xl h-12 px-6 bg-[#3191A6] text-white text-base font-bold hover:bg-[#3191A6]/90 transition-all"
              >
                Log In
              </button>
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="text-sm text-slate-500 text-center">
                ...
                <a
                  href="#"
                  className="text-[#3191A6] font-medium hover:underline flex items-center justify-center mt-1"
                >
