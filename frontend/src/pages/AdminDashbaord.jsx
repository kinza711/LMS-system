      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 space-y-5 overflow-y-auto p-6 md:p-8">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 mb-6">
            <div className="xl:col-span-2 flex flex-col bg-surface-light dark:bg-surface-dark rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 p-6 min-h-[300px]">
              <Trendchart />
            </div>
