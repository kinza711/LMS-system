            ...
            <main className="flex-1 flex flex-col overflow-hidden">
                ...
                <div className="flex-col space-y-5 overflow-y-auto p-6 md:p-8">
                    ...
                    <div className="flex flex-col gap-2">
                        <h1 className="text-[#0d141b] dark:text-white text-3xl font-extrabold leading-tight tracking-tight">Instructor Management</h1>
                        <p className="text-[#4c739a] text-base font-normal">Manage platform administrators, instructors, and student access levels.</p>
                    </div>
                    <UserStats stats={stats} />

                    {/* User Table */}
                    <UserTable users={instructors} onEdit={handleEdit} onDelete={handleDelete} />
                </div>
            </main>
        </div>
    );
